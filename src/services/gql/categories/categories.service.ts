...
export const useGetCategories = (variables?: GetCategoriesQueryVariables) => {
  ...
  return {
    data: data?.Categories as GetCategoriesQuery['Categories'] | undefined,
...
export const useGetCategory = (id: string) => {
  ...
  return {
    data: data?.Category as CategoryFieldsFragment | null | undefined,
    loading,
    error,
  };
};
...
export const useCreateCategory = () => {
  ...
  return {
    ...
    data: data?.createCategory as CategoryFieldsFragment | null | undefined,
    loading,
    error,
  };
};
...
export const useUpdateCategory = () => {
  ...
  return {
    ...
    data: data?.updateCategory as CategoryFieldsFragment | null | undefined,
    loading,
    error,
  };
};
