...
export default function HistoryScreen() {
  ...
  const { personId, accountId, dateFrom, dateTo } = useLocalSearchParams<{
    personId?: string;
    accountId?: string;
    dateFrom?: string;
    dateTo?: string;
  ...
  // Pre-apply filters when navigated from person/account/calendar pages
  useFocusEffect(
    useCallback(() => {
    ...
    }, [personId, accountId, dateFrom, dateTo]),
  );
