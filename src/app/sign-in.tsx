      ...
      >
        <ScrollView
          contentContainerStyle={[
            s.scroll,
            { paddingTop: (insets.top || 44) + 24, paddingBottom: (insets.bottom || 24) + 24 },
          ]}
          ...
          <View style={[s.card, { backgroundColor: C.surfaceLow }]}>
            ...
            <View style={s.logoSection}>
              ...
              <View style={s.logoLabel}>
                <Text style={[s.pikaWord, { color: C.primaryBright }]}>Pika</Text>
              </View>
              <Text style={[s.title, { color: C.onSurface }]}>Welcome Back</Text>
            ...
            <View style={s.dividerRow}>
              ...
              <Text style={[s.dividerText, { color: C.onSurfaceVariant }]}>or</Text>
              <View style={[s.dividerLine, { backgroundColor: C.outlineVariant }]} />
            </View>

            {/* Email */}
            <View style={s.fieldGroup}>
              <Text style={[s.label, { color: C.onSurface }]}>Email Address</Text>
              <View
                style={[
                  s.inputWrap,
                  { backgroundColor: C.surface },
                  emailFocused && { borderColor: C.primaryBright, borderWidth: 1.5 },
                ]}
              >
                <TextInput
            ...
            <View style={s.fieldGroup}>
              <View style={s.labelRow}>
                ...
                <TouchableOpacity activeOpacity={0.75}>
                  <Text style={[s.forgot, { color: C.primaryBright }]}>Forgot Password?</Text>
                </TouchableOpacity>
              </View>
              <View
                style={[
                  s.inputWrap,
                  { backgroundColor: C.surface },
                  passwordFocused && { borderColor: C.primaryBright, borderWidth: 1.5 },
                ]}
              >
                <TextInput
                  style={[s.input, { color: C.onSurface }]}
