...
function TransactionDetailSkeleton({ insets }: { insets: { bottom: number } }) {
  ...
  return (
    ...
    >
      <View
        className="rounded-2xl items-center py-8 gap-4"
...
function AttachmentsCard({
  ...
  attachments: TransactionAttachmentFieldsFragment[];
}) {
  const C = useColors();
...
export default function TransactionDetailScreen() {
  ...
  const catBg =
    tx?.category?.bgColor ?? `${tx?.category?.color ?? "#f59e0b"}22`;
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
                style={{ fontSize: 12, fontWeight: "700", color: amountColor }}
              >
                {typeLabel}
              </Text>
            </View>
            ...
            <View className="items-center gap-0.5 px-6">
              <Text
                className="text-[15px] font-bold text-on-surface text-center"
                numberOfLines={2}
              >
                {tx.title}
              </Text>
          ...
          >
            <View className="flex-row">
              ...
              <View
                style={{ width: 1, backgroundColor: C.outlineVariant + "28" }}
              />
              <View className="flex-1 px-4 py-3.5 gap-1">
                <Text className="text-[10px] font-bold uppercase tracking-[0.7px] text-on-surface-variant">
                  Time
          ...
          {tx.note && (
            ...
            >
              <SectionBlock label="Note">
                <Text className="text-[13px] text-on-surface leading-[20px]">
                  {tx.note}
                </Text>
              </SectionBlock>
            </View>
