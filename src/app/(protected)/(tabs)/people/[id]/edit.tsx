...
export default function EditPersonScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      showAlert({
        title: "Error",
        message: err?.message ?? "Could not update person.",
      });
    } finally {
      setSaving(false);
    }
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              showAlert({
                title: "Error",
                message: err?.message ?? "Could not delete person.",
              });
              setDeleting(false);
            }
          },
  ...
  const displayAvatarUrl =
    avatarUri ?? (avatarRemoved ? null : currentAvatarUrl);
  ...
  return (
    <View className="flex-1 bg-surface">
      ...
      {loadingPerson && !person ? <EditPersonSkeleton insets={insets} /> : null}
