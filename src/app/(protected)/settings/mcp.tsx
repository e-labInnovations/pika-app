...
function PermissionsEditor({
  ...
  const updateUserSettings = (field: "find" | "update", val: boolean) => {
    onChange({
      ...permissions,
      userSettings: { ...permissions.userSettings, [field]: val },
    });
  };

  const updateTool = (
    field: keyof PermissionsState["payload_mcp_tool"],
    val: boolean,
  ) => {
    onChange({
      ...permissions,
      payload_mcp_tool: { ...permissions.payload_mcp_tool, [field]: val },
    });
  };

  const updateResource = (
    field: keyof PermissionsState["payload_mcp_resource"],
    val: boolean,
  ) => {
    onChange({
      ...permissions,
      payload_mcp_resource: {
        ...permissions.payload_mcp_resource,
        [field]: val,
      },
    });
  };
            ...
            <View key={col.key}>
              {i > 0 && (
                <View
                  style={{
                    height: 1,
                    backgroundColor: `${C.outlineVariant}20`,
                    marginHorizontal: 12,
                  }}
                />
              )}
        ...
        >
          ...
          <View style={{ width: 46, alignItems: "center" }}>
            <Switch
              ...
              thumbColor={
                permissions.userSettings.find ? C.primary : C.surfaceHighest
              }
              style={{ transform: [{ scaleX: 0.7 }, { scaleY: 0.7 }] }}
            />
          </View>
          ...
          <View style={{ width: 46, alignItems: "center" }}>
            <Switch
              ...
              thumbColor={
                permissions.userSettings.update ? C.primary : C.surfaceHighest
              }
              style={{ transform: [{ scaleX: 0.7 }, { scaleY: 0.7 }] }}
            />
          </View>
          ...
          <View key={tool.key}>
            ...
            >
              ...
              <Switch
                ...
                thumbColor={
                  permissions.payload_mcp_tool[tool.key]
                    ? C.primary
                    : C.surfaceHighest
                }
          ...
          <View key={res.key}>
            ...
            >
              ...
              <Switch
                ...
                thumbColor={
                  permissions.payload_mcp_resource[res.key]
                    ? C.primary
                    : C.surfaceHighest
                }
                style={{ transform: [{ scaleX: 0.75 }, { scaleY: 0.75 }] }}
...
function KeyFormSheet({
  ...
  const [permissions, setPermissions] =
    useState<PermissionsState>(FULL_PERMISSIONS);
    ...
    >
      <View style={{ flex: 1, backgroundColor: C.surface }}>
        ...
        >
          ...
          <Text
            style={{ fontSize: 13, color: C.onSurfaceVariant, marginTop: 4 }}
          >
    ...
    <View style={{ flex: 1, backgroundColor: C.surface }}>
      ...
      >
        ...
        >
          ...
          >
            MCP API keys let AI assistants like Claude access your Pika data
        ...
        <TouchableOpacity
          onPress={() => WebBrowser.openBrowserAsync(`${API_URL}/mcp-setup`)}
          activeOpacity={0.75}
          style={{
            flexDirection: "row",
            alignItems: "center",
